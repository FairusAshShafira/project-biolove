                ...
                <div class="container-fluid">
                    ...
                    <form method="post" action="proses_insert.php" enctype="multipart/form-data">
                        ...
                        <br>
                            ...
                            <input name="kelas" type="text" class="form-control form-control-sm" id="kelas" placeholder="" >
                        <br>
                            <label for="" class="form-label">Keterangan :</label>
                            <input name="keterangan" type="text" class="form-control form-control-sm" id="keterangan" placeholder="">
                        <br>
                        &nbsp;
