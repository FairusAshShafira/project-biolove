            ...
            <div id="content">
				...
				?>
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        mysqli_query($koneksi, "UPDATE tbl_rekomendasi SET id_kategori='$id_kategori', id_kelas='$id_kelas', rekomendasi='$rekomendasi' WHERE id_rekomendasi='$id_rekomendasi'") or die(mysqli_error($koneksi));
