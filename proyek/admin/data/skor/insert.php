        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Tambah Data Skor</p>
                    ...
                    <form method="post" action="">
                        <div class="container">
                                ...
                                <select name="id_mapel" class="form-control form-control-sm" >
                                    ...
                                    $query = "SELECT username FROM tbl_user WHERE level='user' ";
                            ...
                            <br>
                                ...
                                <input name="username" type="" class="form-control form-control-sm" id="" placeholder="" ></input>
                            <br>
                            &nbsp;
                    ...
                    @$query = "INSERT INTO tbl_skor (id_skor, username, score) VALUES ('', '$username','$id_kelas','$score')";
