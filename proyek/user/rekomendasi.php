    ...
    <span class="ms-5 mt-5 mb-5 kategori semester-container">
        <div class="border border-dark p-3 mb-3">
            <?php
                ...
                $query = "SELECT tr.rekomendasi, k.kategori AS kategori, tr.semester AS semester
            ...
            <div class="border border-dark p-3 mb-3">
                ...
                $querySemester2 = mysqli_query($koneksi, "SELECT tr.rekomendasi,        k.kategori AS kategori, tr.semester AS semester
                                   FROM tbl_rekomendasi tr
                                   JOIN tbl_kategori k ON tr.id_kategori = k.id_kategori
