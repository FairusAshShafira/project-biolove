...
<style>
    *{
    ...
    .user-dropdown {
        ...
        z-index: 1;
        min-width: 160px;
        border-radius: 30px; /* Tambahkan border-radius 30px */
        padding: 10px; /* Padding agar teks tidak terlalu dekat dengan border */
    }
    ...
    .user-dropdown a {
        ...
        display: block;
        text-decoration: none;
        color: #666; /* Ganti warna font menjadi lebih soft */
    }
...
<body>
        ...
        <li class="nav logout">
            <div class="user-profile">
                ...
                <div class="user-dropdown" id="userDropdown">
                    <a href="riwayat_nilai.php">Riwayat</a>
    ...
    <div class="card-border" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <p class="lihat-kelas"><a href="kelas_user.php" class="btn btn-primary">Lihat kelas</a></p>
        </div>
    </div>
    ...
    <p class="keterangan">
        ...
        Ayo coba akses materinya sekarang!! Pergi ke halaman kelas untuk memilih kelas yang kamu inginkan, lalu mulailah belajar!!
    </p>
